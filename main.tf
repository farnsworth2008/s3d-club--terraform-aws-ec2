...
module "sg_egress" {
  source = "github.com/s3d-club/terraform-aws-sg_egress_open?ref=0.1.11-s3d-1003"
...
module "sg_ingress" {
  source = "github.com/s3d-club/terraform-aws-sg_ingress_ssh?ref=0.1.10-s3d-1003"
